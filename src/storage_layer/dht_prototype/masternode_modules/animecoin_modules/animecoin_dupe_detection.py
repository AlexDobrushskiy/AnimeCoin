...
def measure_similarity(candidate_fingerprint, fingerprint_table):
    ...
    kendall_thresh = NetWorkSettings.DUPE_DETECTION_KENDALL_THRESHSHOLD
    hoeffding_thresh = NetWorkSettings.DUPE_DETECTION_HOEFFDING_THRESHHOLD
