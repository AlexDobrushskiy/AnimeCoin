...
class RPCClient:
    def __init__(self, logger, privkey, pubkey, nodeid, ip, port, mnpubkey):
    ...
    async def send_rpc_ping(self, data):
        self.__logger.debug("PING REQUEST to %s" % self)
        ...
        self.__logger.debug("PING RESPONSE from %s, msg: %s" % (self, response_data))
