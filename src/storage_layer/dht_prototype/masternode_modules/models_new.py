...
class ActivationTicket(TicketModelBase):
    ...
    def validate(self, imagedata, blockchain):
...
class FinalRegistrationTicket(TicketModelBase):
    ...
    def validate(self, masternode_ordering, blockchain):
        ...
        if self.signature_author.pubkey != self.registration_ticket.author:
        ...
        # validate signatures
        self.signature_author.validate(self.registration_ticket)
        self.signature_1.validate(self.registration_ticket)
        self.signature_2.validate(self.registration_ticket)
        self.signature_3.validate(self.registration_ticket)

        # validate registration ticket
        self.registration_ticket.validate(blockchain)
