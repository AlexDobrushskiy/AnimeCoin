...
from dht_prototype.masternode_modules.helpers_type import ensure_type_of_field


class MNDeamonSettings:
    def __init__(self, settings):
        self.regtest = ensure_type_of_field(settings, "regtest", str)
...
NetWorkSettings.ANIMECOIND_BINARY = "/home/synapse/dev/toptal/animecoin/code/animecoin_blockchain/AnimeCoin/src/animecoind"
NetWorkSettings.PYTHONPATH = "python"
NetWorkSettings.BASEDIR = os.path.abspath(os.path.join(__file__, "..", "..", ".."))
NetWorkSettings.DJANGO_ROOT = os.path.join(NetWorkSettings.BASEDIR, "dht_prototype", "artex_frontend")
