...
class MasterNodeSettings:
    def __init__(self, basedir, privkey, pubkey):
...
NetWorkSettings.CHUNKSIZE = 1 * 1024*1024*1024  # 1MB

NetWorkSettings.IMAGE_MAX_SIZE = 100 * 1024*1024*1024  # 10MB
NetWorkSettings.THUMBNAIL_MAX_SIZE = 25 * 1024*1024  # 25kbyte
# END
