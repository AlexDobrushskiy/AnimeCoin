from .models_new import RegistrationTicket, MetaData, Signature
...
def masternode_verify_registration_ticket(signature_regticket, regticket_serialized, metadata_serialized,
    ...
    metadata = MetaData(serialized=metadata_serialized)

    # validate client's signature on the ticket
    assert(signed_regticket.pubkey == regticket.author)
    signed_regticket.validate(regticket_serialized)
