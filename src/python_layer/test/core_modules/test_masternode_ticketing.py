...
class TestArtRegistrationWithMockMNs(unittest.TestCase):
    def setUp(self):
        ...
        mn0 = ArtRegistrationServer(mn0_privkey, mn0_pubkey, self.chainwrapper, self.chunkstorage)
        ...
        mn1 = ArtRegistrationServer(mn1_privkey, mn1_pubkey, self.chainwrapper, self.chunkstorage)
        ...
        mn2 = ArtRegistrationServer(mn2_privkey, mn2_pubkey, self.chainwrapper, self.chunkstorage)

        self.nodemanager.get_masternode_ordering = mock.MagicMock(return_value=[mn0, mn1, mn2])
