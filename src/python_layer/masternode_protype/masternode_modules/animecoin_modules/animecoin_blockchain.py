...
from masternode_protype.masternode_modules.helpers import get_hexdigest, get_digest
from masternode_protype.masternode_modules.settings import NetWorkSettings
...
def store_data_in_utxo(jsonrpc, input_data):
    ...
    change -= out_value
    receiving_animecoin_blockchain_address = jsonrpc.getnewaddress()
