...
from dht_prototype.masternode_modules.masternode_logic import MasterNodeLogic
from dht_prototype.masternode_modules.helpers import get_hexdigest, getrandbytes
